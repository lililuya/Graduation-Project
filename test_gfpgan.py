...
def cut_frame_use_cv2(out_frame_dir, vid_path = "./save_videos/talking_2024-05-03-05-14-59.mp4"):
...
def cut_frame_use_moviepy(out_frame_dir, vid_path="./demo/test_gpfgan/o"):
    if not os.path.exists(out_frame_dir):
        os.makedirs(out_frame_dir, exist_ok=True)
...
def test_gfpgan_tensorrt(image_dir, res_path, onnx_path = "./restoration/GFPGANv1.4.onnx"):
...
if __name__=="__main__":
    out_frame_dir = "./demo/test_gpfgan/o1"
    res_path = "./demo/test_gpfgan/p1"
